...
const Navigation = ({ scrollToSection, aboutRef, experienceRef, portfolioRef, contactRef }) => {
	...
	return (
		<nav>
			...
			<ul>
				<li>
					<a
						href='https://github.com/lifeofmatsu'
						className='custom-icon custom-icon_hover'
						target='_blank'
				...
				<li>
					<a
						href='https://www.linkedin.com/in/lifeofmatsu/'
						className='custom-icon custom-icon_hover'
						target='_blank'
						rel='noopener noreferrer'
				...
				<li>
					<a
						href='https://www.instagram.com/lifeofmatsu/'
						className='custom-icon custom-icon_hover'
						target='_blank'
						rel='noopener noreferrer'
				...
				<li>
					<a
						href='https://twitter.com/lifeofmatsu'
						className='custom-icon custom-icon_hover'
						target='_blank'
						rel='noopener noreferrer'
